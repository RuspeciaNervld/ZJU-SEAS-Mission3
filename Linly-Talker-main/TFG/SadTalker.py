...
class SadTalker():
    ...
    def get_processed_pic(self,preprocess ='crop',size=256, pic_path='nervld_pic_path.jpg', first_frame_dir='nervld_test_firstframe'):
        checkpoint_path='checkpoints'
        config_path='src/config'
        sadtalker_paths = init_path(checkpoint_path, config_path, 256, False, preprocess)
...
if __name__ == '__main__':
    ...
    sadtalker = SadTalker()
    # 进行测试
    print(sadtalker.get_processed_pic())